...
const resourceIcons: Record<string, React.ReactNode> = {
  ...
  doc: <FileText className="size-4 text-[#1d4ed8]" />,
  link: <ExternalLink className="size-4 text-[#1d4ed8]" />,
};
            ...
            return (
              <div key={section.id}>
                ...
                >
                  ...
                  {sectionCompleted && (
                    <CheckCircle2 className="size-3.5 text-[#1d4ed8] shrink-0" />
                  )}
                </button>
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                ...
                                lesson.isCompleted && !isActive && 'text-[#1d4ed8]'
                              )}
                            >
                              {lesson.isCompleted ? (
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="relative w-full bg-neutral-900 aspect-video max-h-[60vh] flex items-center justify-center">
            <div className="absolute inset-0 bg-gradient-to-br from-[#0a1a3e]/30 to-neutral-900" />
