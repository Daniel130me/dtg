  ...
  return (
    <main className='flex-1'>
      ...
      <section className='relative overflow-hidden'>
        <div className='absolute inset-0 bg-gradient-to-br from-teal-900 via-emerald-900 to-teal-950' />
        <div className='absolute inset-0 opacity-10'>
          <div className='absolute top-20 left-10 size-72 rounded-full bg-teal-400 blur-3xl' />
          <div className='absolute bottom-10 right-20 size-96 rounded-full bg-emerald-400 blur-3xl' />
          <div className='absolute top-40 right-1/3 size-64 rounded-full bg-teal-300 blur-3xl' />
        </div>
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36'>
          <motion.div
            ...
            className='max-w-3xl'
          >
            <Badge className='bg-teal-500/20 text-teal-200 border-teal-500/30 mb-6 text-sm px-3 py-1'>
              <Star className='size-3.5 mr-1.5 fill-teal-300 text-teal-300' />
              Trusted by {analyticsData.totalStudents.toLocaleString()}+ students
            </Badge>
            <h1 className='text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight mb-6'>
              Master In-Demand Skills{' '}
              <span className='text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-emerald-300'>with DTG</span>
            </h1>
            ...
            <div className='flex flex-col sm:flex-row gap-3'>
              <Button size='lg' className='bg-white text-teal-900 hover:bg-white/90 font-semibold text-base px-8' onClick={() => navigate('courses')}>
                Browse Courses <ArrowRight className='ml-1.5 size-4' />
              </Button>
              <Button size='lg' variant='outline' className='border-teal-400/30 text-teal-200 hover:bg-teal-800/50 text-base px-8' onClick={() => navigate('about')}>
                Learn More
              </Button>
            </div>
          </motion.div>
          ...
          >
            {[
              ...
              <div key={stat.label} className='text-center'>
                ...
                <div className='text-sm text-teal-300/70 mt-1'>{stat.label}</div>
              </div>
            ))}
          </motion.div>
        </div>
          ...
          >
            <div className='flex justify-center lg:justify-start'>
              <div className='relative'>
                <div className='w-64 h-64 sm:w-80 sm:h-80 rounded-2xl bg-gradient-to-br from-primary to-emerald-700 flex items-center justify-center'>
      ...
      {/* Final CTA */}
      <section className='py-16 sm:py-20 bg-gradient-to-br from-teal-900 via-emerald-900 to-teal-950 relative overflow-hidden'>
        <div className='absolute inset-0 opacity-10'>
          <div className='absolute top-10 right-10 size-64 rounded-full bg-teal-400 blur-3xl' />
          <div className='absolute bottom-10 left-20 size-80 rounded-full bg-emerald-400 blur-3xl' />
        </div>
        <div className='relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-teal-100/80 text-lg mb-8 max-w-xl mx-auto'>
            ...
            <div className='flex flex-col sm:flex-row gap-3 justify-center'>
              ...
              <Button size='lg' variant='outline' className='border-teal-400/30 text-teal-200 hover:bg-teal-800/50 text-base px-8' onClick={() => navigate('register')}>
                Create Free Account
              </Button>
            </div>
          </motion.div>
